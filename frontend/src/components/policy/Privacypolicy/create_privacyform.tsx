...
interface CreatePrivacyPolicyFormProps {
  onCreate: (newPolicy: PrivacyPolicyProp) => void
  onClose: () => void
}

const CreatePrivacyPolicyForm: React.FC<CreatePrivacyPolicyFormProps> = ({
  onCreate,
  onClose,
}) => {
  ...
  return (
    <div className="rounded-3xl bg-white p-6 dark:bg-gray-900">
      <h4 className="mb-6 text-xl font-semibold text-gray-800 dark:text-white/90">
        สร้างนโยบายความเป็นส่วนตัวใหม่
      </h4>
