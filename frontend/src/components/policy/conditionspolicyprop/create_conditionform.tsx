...
interface CreateConditionFormProps {
  onCreate: (newPolicy: ConditionPolicyProp) => void
  onClose: () => void
}

const CreateConditionForm: React.FC<CreateConditionFormProps> = ({
  onCreate,
  onClose,
}) => {
  const [condition_title, setTitle] = useState("")
  const [condition_content, setContent] = useState("")
