...
const CreateServiceItemForm: React.FC<CreateServiceItemFormProps> = ({
  serviceId,
  reFetching,
  onClose,
  editData,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      data.append("service_category_id", serviceId)
      if (selectedFile) data.append("image", selectedFile)

      setIsUploading(true)

      const url = editData
        ? `${API_ENDPOINT}${API_VERSION}pages/service-item/update/${editData.id}`
        : `${API_ENDPOINT}${API_VERSION}pages/service-item/create`
