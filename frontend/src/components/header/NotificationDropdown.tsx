  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="shadow-theme-lg dark:bg-gray-dark absolute mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:-right-[240px] sm:w-[361px] lg:right-0 dark:border-gray-800"
      >
